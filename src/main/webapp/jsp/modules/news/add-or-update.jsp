                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>公告信息名称</label>
                                        <input id="newsName" name="newsName" class="form-control"
                                               placeholder="公告信息名称">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>公告信息图片</label>
...
<script>
    ...
    function upload() {
        ...
        $('#newsPhotoupload').fileupload({
            ...
            dataType: 'json',
                ...
                document.getElementById('newsPhotoImg').setAttribute('src',photoUrl);
    ...
    function getContent() {
        ...
        if($("#newsContentupload").length>0) {
            ...
            if (newsContentEditor.hasContents()) {
                $('#newsContent-input').attr('value', newsContentEditor.getPlainTxt());
            }
        }
    }
    //数字检查
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                newsName: "公告信息名称不能为空",
                newsPhoto: "公告信息图片不能为空",
                insertTime: "公告信息时间不能为空",
                newsContent: "公告信息详情不能为空",
            }
        }).form();
    }
    ...
    function showImg() {
        <!--  当前表的图片  -->
        $("#newsPhotoImg").attr("src",ruleForm.newsPhoto);
