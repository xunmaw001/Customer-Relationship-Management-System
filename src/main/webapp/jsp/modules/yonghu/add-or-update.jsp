                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>岗位信息</label>
                                        <select id="gangweiTypesSelect" name="gangweiTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>职务管理</label>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationGangweitypesSelect(){
            var gangweiTypesSelect = document.getElementById('gangweiTypesSelect');
            if(gangweiTypesSelect != null && gangweiTypesOptions != null  && gangweiTypesOptions.length > 0 ){
                for (var i = 0; i < gangweiTypesOptions.length; i++) {
                    gangweiTypesSelect.add(new Option(gangweiTypesOptions[i].indexName,gangweiTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(gangweiTypesSelect != null && gangweiTypesOptions != null  && gangweiTypesOptions.length > 0 ) {
            for (var i = 0; i < gangweiTypesOptions.length; i++) {
                if (gangweiTypesOptions[i].codeIndex == ruleForm.gangweiTypes) {//下拉框value对比,如果一致就赋值汉字
                        gangweiTypesSelect.options[i].selected = true;
                }
            }
        }
        ...
        if(zhiwuTypesSelect != null && zhiwuTypesOptions != null  && zhiwuTypesOptions.length > 0 ) {
            for (var i = 0; i < zhiwuTypesOptions.length; i++) {
                if (zhiwuTypesOptions[i].codeIndex == ruleForm.zhiwuTypes) {//下拉框value对比,如果一致就赋值汉字
                        zhiwuTypesSelect.options[i].selected = true;
                }
            }
        }
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationGangweitypesSelect();
