...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">客户信息管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">客户信息列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">客户信息列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        性别
                                        <div class="layui-input-inline">
                                            <select name="sexTypesSelectSearch"  style="width: 150px;" id="sexTypesSelectSearch" class="form-control form-control-sm"
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //邮箱
            var kehuEmailCell = document.createElement('td');
            kehuEmailCell.innerHTML = item.kehuEmail;
            row.appendChild(kehuEmailCell);
            ...
            //客户级别
            var jibieTypesCell = document.createElement('td');
            jibieTypesCell.innerHTML = item.jibieValue;
            row.appendChild(jibieTypesCell);


            //客户来源
            var laiyuanTypesCell = document.createElement('td');
            laiyuanTypesCell.innerHTML = item.laiyuanValue;
            row.appendChild(laiyuanTypesCell);


            //跟进方式
            var genjinTypesCell = document.createElement('td');
            genjinTypesCell.innerHTML = item.genjinValue;
            row.appendChild(genjinTypesCell);
