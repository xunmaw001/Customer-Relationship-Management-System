    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑订单信息</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑订单信息</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">订单信息信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 kehu">
                                        <label>客户级别</label>
                                        <input id="jibieValue" name="jibieValue" class="form-control"
                                               placeholder="客户级别" readonly>
                                    </div>
                                    <div class="form-group col-md-6 kehu">
                                        <label>客户来源</label>
                                        <input id="laiyuanValue" name="laiyuanValue" class="form-control"
                                               placeholder="客户来源" readonly>
                                    </div>
                                    <div class="form-group col-md-6 kehu">
                                        <label>跟进方式</label>
                                        <input id="genjinValue" name="genjinValue" class="form-control"
                                               placeholder="跟进方式" readonly>
                                    </div>
                            <!-- 当前表的字段 -->
                                    <input id="updateId" name="id" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>订单编号</label>
                                        <input id="dingdanBianhao" name="dingdanBianhao" class="form-control"
                                               placeholder="订单编号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>订单名称</label>
                                ...
                                <input id="kehuId" name="kehuId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>签订时间</label>
                                        <input id="qiandingTime-input" name="qiandingTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>金额</label>
                                        <input id="yonghuMoney" name="yonghuMoney" class="form-control"
                                               onchange="yonghuMoneyChickValue(this)" placeholder="金额">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>订单详情</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            let data = {};
            getContent();
            if(window.sessionStorage.getItem('role') != '客户信息'){//当前登录用户不为这个
                if($("#kehuId") !=null){
        ...
        function initializationkehuSelect() {
            ...
            if(kehuSelect != null && kehuOptions != null  && kehuOptions.length > 0 ) {
                for (var i = 0; i < kehuOptions.length; i++) {
                        kehuSelect.add(new Option(kehuOptions[i].yonghuName, kehuOptions[i].id));
                }
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function yonghuMoneyChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                dingdanBianhao: "required",
                dingdanName: "required",
                kehuId: "required",
                qiandingTime: "required",
                yonghuMoney: "required",
                hetongContent: "required",
            },
            messages: {
                dingdanBianhao: "订单编号不能为空",
                dingdanName: "订单名称不能为空",
                kehuId: "签订客户不能为空",
                qiandingTime: "签订时间不能为空",
                yonghuMoney: "金额不能为空",
                hetongContent: "订单详情不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#yonghuMoney").val(ruleForm.yonghuMoney);
    ...
    function kehuDataBind(){
        ...
        $("#jibieValue").val(ruleForm.jibieValue);
        $("#laiyuanValue").val(ruleForm.laiyuanValue);
        $("#genjinValue").val(ruleForm.genjinValue);
    }
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            // 金额设置不可选
            $('#yonghuMoney').attr('readonly', 'readonly');
        }
        else{
            // alert("未知情况.......");
