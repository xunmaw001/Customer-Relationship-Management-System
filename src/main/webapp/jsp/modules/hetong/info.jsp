            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">合同信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="hetongName" name="hetongName" class="form-control"
                                               v-model="ruleForm.hetongName" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>签订客户</label>
                                        <input id="qianName" name="qianName" class="form-control"
                                               v-model="ruleForm.qianName" readonly>
                                    </div>
...
<script>
    ...
    function setDownloadBtn() {
        var hetongFileUrl = "download('" + ruleForm.hetongFile + "')";
        $("#hetongFile").attr("onclick", hetongFileUrl);
